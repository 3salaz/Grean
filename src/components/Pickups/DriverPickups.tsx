...
const DriverPickups: React.FC<DriverPickupsProps> = ({ viewMode }) => {
  ...
  const handleCompletePickup = async (
    ...
    return (
      <section className="h-full ion-padding overflow-auto flex flex-col justify-end">
        <IonHeader className="">
        ...
        <main className="flex-grow flex flex-col overflow-auto rounded-md gap-2">
          {viewMode === "default" ? (
            acceptingPickupId ? (
              <div className="flex-grow ion-padding-vertical">
                <IonRow className="h-full bg-white justify-center items-center">
                  <IonCol >
                      ...
                      <IonItem slot="header" className="bg-red-400 w-full">
                        <IonRow>
                          ...
                          <IonCol size="12" className="ion-padding-bottom">
                            ...
                            <div className="text-xs">{pickup.materials.map(m => m.type.charAt(0).toUpperCase() + m.type.slice(1)).join(", ")}</div>
                          </IonCol>
                        </IonRow>
              ...
              <div className="flex-grow flex-grow flex flex-col overflow-auto rounded-md gap-2 ion-padding-top">
                <IonRow className="h-full">
                  <IonCol className="flex flex-col items-center justify-center bg-white rounded-md ion-padding">
                    <img
                      src={noPickupIcon}
          ...
          <IonRow className="ion-padding bg-white rounded-md">
            <IonCol size="12">
              <IonText className="text-lg font-semibold">Pickups In Progress</IonText>
            </IonCol>
            <IonCol size="12">
