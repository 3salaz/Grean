...
function TabBar({ active, setActive }) {
  ...
  return (
    <footer className="w-full border-t-2 z-30 border-t-white h-[10%] fixed bottom-0 bg-slate-800 rounded-t-md">
      <ul className="flex relative justify-center h-full container max-w-xl mx-auto">
        <motion.div
          ...
          <li key={i} className="w-16">
            ...
            >
              ...
              <motion.span
                className={`${
                  active === i
                    ? "translate-y-2 duration-700 opacity-100 text-xs font-bold"
