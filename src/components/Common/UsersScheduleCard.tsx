...
export default function UserScheduleCard() {
    ...
    return (
            <motion.section
                ...
                className="h-full w-full flex flex-col justify-end bg-[#75B657]/70 rounded-md drop-shadow-xl">
                ...
                <main className="flex-grow overflow-auto flex flex-col gap-2">
                    {relevantPickups.length === 0 ? (
                        <div className="flex flex-col items-center justify-center flex-grow bg-white py-12">
                            <img src={noPickupsIcon} alt="No pickups" className="w-16 h-16" />
                            <IonText className="text-sm text-gray-500 font-bold">
