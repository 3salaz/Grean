...
const StatsTab = () => {
  ...
  return (
    <main
      id="StatsTab"
      className="w-full h-full z-20 flex flex-col items-center justify-center relative p-6 "
    >
      <div className="w-full h-[full] overflow-auto snap-y snap-mandatory hide-scroll no-scroll overscroll-none  text-white">
        <div className="w-full h-full bg-slate-800 border-b-white border-b-2 mx-auto container section relative justify-between items-center snap-always snap-center p-4 flex flex-col gap-2 rounded-md">
