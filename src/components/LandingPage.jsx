          ...
          {user ? (
            <Link to="/account">
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="w-20 mt-32 h-20 border-4 border-grean text-grean p-2 bg-white rounded-full flex items-center justify-center"
              >
                Account
              </motion.button>
            </Link>
            ...
            >
              <div className="absolute w-32 text-center p-2 bg-white rounded-lg flex items-center justify-center">
                Sign In
              </div>
            </motion.button>
          )}
