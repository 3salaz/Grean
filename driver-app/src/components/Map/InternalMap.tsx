    ...
    <main className="relative w-full flex-grow overflow-auto">
      ...
      <AnimatePresence>
        {!selectedLocation && (
          ...
          >
            <IonGrid className="w-full max-w-xl flex-col gap-2 rounded-xl">
              <IonRow class="ion-padding">
                <IonCol size="8" className="relative shadow-lg">
                  <input
                    type="text"
                    ...
                    onChange={(e) => {
                      ...
                      if (value.trim() === "") {
                        ...
                        const results = filteredLocations.filter((loc) =>
                          [loc.businessName, loc.homeName, loc.address].some((field) =>
                    ...
                    className="w-full p-2 border-2 border-[#75B657] bg-white rounded-lg focus:outline-none focus:ring-0 focus:ring-[#75B657]"
                  />
          ...
          "
              ...
              <IonRow
                ref={filterRowRef}
                className="flex-nowrap overflow-x-auto no-scrollbar bg-white p-2 py-3 rounded-b-xl shadow-md text-xs gap-2 max-w-lg mx-auto"
          ...
          >
            <IonCard className="bg-white max-w-xl mx-auto border-2 border-[#75B657] h-full min-h-[200px] relative ion-padding rounded-md flex flex-col gap-4">
              <IonCardHeader color="light" className="ion-padding">
                <IonCardTitle>{selectedLocation.businessName || "Unnamed Business"}</IonCardTitle>
                  ...
                  <IonRow className="ion-padding-horizontal">
                    <IonCol size="12">
                      <p className="text-gray-600">
                        Category: {selectedLocation.category || "N/A"}
                      </p>
                    </IonCol>
                    <IonCol size="12">
                      <p
                      ...
                      {(selectedLocation.businessBio || "").length > 100 && (
                        <button
