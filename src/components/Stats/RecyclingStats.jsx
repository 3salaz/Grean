...
function RecyclingStats() {
  return (
    <IonRow className="ion-padding border-b border-slate-200">
      <IonCol>
        <IonCard className="shadow-none bg-white ion-padding">
          <IonCardHeader>
            <IonCardTitle className="text-xl">Recycling Stats</IonCardTitle>
          </IonCardHeader>
