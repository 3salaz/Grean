...
import SignIn from "../SignIn"; // Import the actual sign-in form
...
function Landing() {
  ...
  return (
    <section className="relative h-full w-full flex justify-center items-center snap-center">
      <img className="absolute inset-0 w-full h-full object-cover blur-sm" src={Background} alt="Woman sitting atop a rock edge which is extending outwards over a river."/>
